...
local Toggle2 = Tabs.Main:CreateToggle("MyToggle", {Title = "esp", Default = false})
...
local remote = game.ReplicatedStorage.RemoteEvents.ToolDamageObject
local charactersFolder = workspace:WaitForChild("Characters")

-- Dropdown UI
local selectedMobs = {}
local MultiDropdown = Tabs.Main:CreateDropdown("Mob Selector", {
    Title = "Select Mobs",
    Description = "Choose which mobs to auto-hit",
